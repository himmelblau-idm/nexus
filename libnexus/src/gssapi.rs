...
use picky_asn1::wrapper::{
    ExplicitContextTag0, ExplicitContextTag2, ObjectIdentifierAsn1,
...
pub(crate) fn create_security_blob(
    mech_token: Option<ExplicitContextTag2<OctetStringAsn1>>,
    ...
    let blob = ApplicationTag0(GssApiNegInit {
        ...
        neg_token_init: ExplicitContextTag0(NegTokenInit {
            ...
            mech_token: Optional(mech_token),
